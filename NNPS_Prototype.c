...
#define __PYX_HAVE__NNPS_Prototype
#define __PYX_HAVE_API__NNPS_Prototype
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'NNPS_Prototype' */
...
static PyObject *__pyx_f_14NNPS_Prototype_direct_search(__Pyx_memviewslice, long, double, double, int, double, double, double, double, double, double, int, int, int, int, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_14NNPS_Prototype_create_grid(int, int, int, __Pyx_memviewslice, int, int, int, int, double, double, double, double, double, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_14NNPS_Prototype_allocate_particles(__Pyx_memviewslice, int, int, int, double, int, __Pyx_memviewslice, __Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_14NNPS_Prototype_linked_list(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, int, long, __Pyx_memviewslice, int, double, double, double, double, double, double, int, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "NNPS_Prototype"
extern int __pyx_module_is_main_NNPS_Prototype;
int __pyx_module_is_main_NNPS_Prototype = 0;

/* Implementation of 'NNPS_Prototype' */
...
static const char __pyx_k_pbc_x[] = "pbc_x";
static const char __pyx_k_pbc_y[] = "pbc_y";
static const char __pyx_k_pbc_z[] = "pbc_z";
...
static const char __pyx_k_sim_dim[] = "sim_dim";
...
static const char __pyx_k_ipn_pairs[] = "ipn_pairs";
...
static const char __pyx_k_trial_size[] = "trial_size";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_cells_parts[] = "cells_parts";
static const char __pyx_k_parts_cells[] = "parts_cells";
...
static const char __pyx_k_Direct_search_Cython[] = "Direct search Cython";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_Linked_list_NNPS_Cython[] = "Linked-list NNPS Cython";
...
static PyObject *__pyx_kp_s_Direct_search_Cython;
...
static PyObject *__pyx_kp_s_Linked_list_NNPS_Cython;
...
static PyObject *__pyx_n_s_cells_parts;
...
static PyObject *__pyx_n_s_ipn_pairs;
...
static PyObject *__pyx_n_s_parts_cells;
static PyObject *__pyx_n_s_pbc;
static PyObject *__pyx_n_s_pbc_x;
static PyObject *__pyx_n_s_pbc_y;
static PyObject *__pyx_n_s_pbc_z;
...
static PyObject *__pyx_n_s_sim_dim;
...
static PyObject *__pyx_n_s_trial_size;
...
static PyObject *__pyx_pf_14NNPS_Prototype_direct_search(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, long __pyx_v_num_parts, double __pyx_v_h, double __pyx_v_dp, int __pyx_v_sim_dim, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size); /* proto */
static PyObject *__pyx_pf_14NNPS_Prototype_2create_grid(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_cols, int __pyx_v_num_rows, int __pyx_v_num_layers, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, double __pyx_v_x_max, double __pyx_v_y_max, double __pyx_v_z_max, double __pyx_v_dp, double __pyx_v_h); /* proto */
static PyObject *__pyx_pf_14NNPS_Prototype_4allocate_particles(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, int __pyx_v_num_cols, int __pyx_v_num_rows, int __pyx_v_num_cells, double __pyx_v_h, int __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_parts_cells, double __pyx_v_dp); /* proto */
static PyObject *__pyx_pf_14NNPS_Prototype_6linked_list(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_parts_cells, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_grid, double __pyx_v_h, double __pyx_v_dp, int __pyx_v_sim_dim, long __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z); /* proto */
...
static PyObject *__pyx_pw_14NNPS_Prototype_1direct_search(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14NNPS_Prototype_direct_search(__Pyx_memviewslice __pyx_v_r, long __pyx_v_num_parts, double __pyx_v_h, double __pyx_v_dp, CYTHON_UNUSED int __pyx_v_sim_dim, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_t = NULL;
  int __pyx_v_undersized;
  long __pyx_v_part_i;
  long __pyx_v_part_j;
  long __pyx_v_ipn;
  double __pyx_v_kr;
  double __pyx_v_tol;
  double __pyx_v_r_ijx;
  double __pyx_v_r_ijy;
  double __pyx_v_r_ijz;
  double __pyx_v_rij;
  double __pyx_v_x_dist;
  double __pyx_v_y_dist;
  double __pyx_v_z_dist;
  double __pyx_v_periodic_xdist;
  double __pyx_v_periodic_ydist;
  double __pyx_v_periodic_zdist;
  ...
  __Pyx_RefNannySetupContext("direct_search", 0);
  __Pyx_TraceCall("direct_search", __pyx_f[0], 12, 0, __PYX_ERR(0, 12, __pyx_L1_error));

  /* "NNPS_Prototype.pyx":16
 *                     int[:, ::1] ipn_pairs, int trial_size):
 * 
 *     t = Timer()             # <<<<<<<<<<<<<<
 *     t.tic()
 * 
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_Timer); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
 ...
 *     cdef:
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_t, __pyx_n_s_tic); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
 ...
 *         long ipn = 0
 */
  __pyx_v_undersized = 0;

  /* "NNPS_Prototype.pyx":22
 *         int undersized = 0
 *         long part_i, part_j
 *         long ipn = 0             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_kr = (2.0 * __pyx_v_h);

  /* "NNPS_Prototype.pyx":24
 *         long ipn = 0
 *         double kr = 2 * h    # kernel radius.
 *         double tol = 0.001 * dp             # <<<<<<<<<<<<<<
 *         double r_ijx, r_ijy, r_ijz, rij, x_dist, y_dist, z_dist, periodic_xdist, periodic_ydist, periodic_zdist
 * 
 */
  __pyx_v_tol = (0.001 * __pyx_v_dp);

  /* "NNPS_Prototype.pyx":27
 *         double r_ijx, r_ijy, r_ijz, rij, x_dist, y_dist, z_dist, periodic_xdist, periodic_ydist, periodic_zdist
 * 
 ...
 */
  __pyx_t_4 = (__pyx_v_num_parts + 1);
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 1; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_part_i = __pyx_t_6;

    /* "NNPS_Prototype.pyx":28
 * 
 *     for part_i in range(1, num_parts + 1):
 *         for part_j in range(part_i, num_parts + 1):             # <<<<<<<<<<<<<<
 *             r_ijx = r[part_i, 0] - r[part_j, 0]
 ...
 */
    ...
    __pyx_t_8 = __pyx_t_7;
    for (__pyx_t_9 = __pyx_v_part_i; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_part_j = __pyx_t_9;

      /* "NNPS_Prototype.pyx":29
 *     for part_i in range(1, num_parts + 1):
 *         for part_j in range(part_i, num_parts + 1):
 *             r_ijx = r[part_i, 0] - r[part_j, 0]             # <<<<<<<<<<<<<<
 *             r_ijy = r[part_i, 1] - r[part_j, 1]
 ...
 */
      __pyx_t_10 = __pyx_v_part_i;
      __pyx_t_11 = 0;
      __pyx_t_12 = __pyx_v_part_j;
      __pyx_t_13 = 0;
      __pyx_v_r_ijx = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_10 * __pyx_v_r.strides[0]) )) + __pyx_t_11)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_12 * __pyx_v_r.strides[0]) )) + __pyx_t_13)) ))));

      /* "NNPS_Prototype.pyx":30
 *         for part_j in range(part_i, num_parts + 1):
 *             r_ijx = r[part_i, 0] - r[part_j, 0]
 *             r_ijy = r[part_i, 1] - r[part_j, 1]             # <<<<<<<<<<<<<<
 *             r_ijz = r[part_i, 2] - r[part_j, 2]
 * 
 */
      __pyx_t_14 = __pyx_v_part_i;
      __pyx_t_15 = 1;
      __pyx_t_16 = __pyx_v_part_j;
      __pyx_t_17 = 1;
      __pyx_v_r_ijy = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_14 * __pyx_v_r.strides[0]) )) + __pyx_t_15)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_16 * __pyx_v_r.strides[0]) )) + __pyx_t_17)) ))));

      /* "NNPS_Prototype.pyx":31
 *             r_ijx = r[part_i, 0] - r[part_j, 0]
 *             r_ijy = r[part_i, 1] - r[part_j, 1]
 *             r_ijz = r[part_i, 2] - r[part_j, 2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_18 = __pyx_v_part_i;
      __pyx_t_19 = 2;
      __pyx_t_20 = __pyx_v_part_j;
      __pyx_t_21 = 2;
      __pyx_v_r_ijz = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_18 * __pyx_v_r.strides[0]) )) + __pyx_t_19)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_20 * __pyx_v_r.strides[0]) )) + __pyx_t_21)) ))));

      /* "NNPS_Prototype.pyx":37
 ...
 *                 # =========================================== X-Coordinate =============================================
 */
      __pyx_t_22 = ((__pyx_v_pbc == 1) != 0);
      if (__pyx_t_22) {

        /* "NNPS_Prototype.pyx":40
 * 
 *                 # =========================================== X-Coordinate =============================================
 *                 if pbc_x == 1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_22 = ((__pyx_v_pbc_x == 1) != 0);
        if (__pyx_t_22) {

          /* "NNPS_Prototype.pyx":43
 * 
 *                     # Regular distance in the x-direction.
 *                     x_dist = abs(r_ijx)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_v_x_dist = fabs(__pyx_v_r_ijx);

          /* "NNPS_Prototype.pyx":46
 * 
 *                     # Check if particle j is not natural neighbor (only through periodicity).
 *                     if x_dist > kr:             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_22 = ((__pyx_v_x_dist > __pyx_v_kr) != 0);
          if (__pyx_t_22) {

            /* "NNPS_Prototype.pyx":49
 * 
 *                         # Find the periodic distance in the x-direction.
 ...
 */
            __pyx_v_periodic_xdist = (((__pyx_v_x_dist - __pyx_v_x_max) + __pyx_v_x_min) - __pyx_v_dp);

            /* "NNPS_Prototype.pyx":52
 * 
 *                         # If periodic distance is larger than the regular distance, then keep regular distance in x-direction
 ...
 * 
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_xdist) >= __pyx_v_x_dist) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":53
 *                         # If periodic distance is larger than the regular distance, then keep regular distance in x-direction
 *                         if abs(periodic_xdist) >= x_dist:
 *                             periodic_xdist = x_dist             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_v_periodic_xdist = __pyx_v_x_dist;
 ...
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_xdist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":59
 * 
 *                             # The component is corrected with the periodic distance within the particle support.
 ...
 *                 # ========================================== Y-Coordinate ==============================================
 */
              __pyx_v_r_ijx = __pyx_v_periodic_xdist;
 ...
 * 
 */
        __pyx_t_22 = ((__pyx_v_pbc_y == 1) != 0);
        if (__pyx_t_22) {

          /* "NNPS_Prototype.pyx":63
 *                 # ========================================== Y-Coordinate ==============================================
 *                 if pbc_y == 1:
 *                     y_dist = abs(r_ijy)             # <<<<<<<<<<<<<<
 * 
 *                     if y_dist > kr:
 */
          __pyx_v_y_dist = fabs(__pyx_v_r_ijy);

          /* "NNPS_Prototype.pyx":65
 *                     y_dist = abs(r_ijy)
 * 
 *                     if y_dist > kr:             # <<<<<<<<<<<<<<
 ...
 * 
 */
          __pyx_t_22 = ((__pyx_v_y_dist > __pyx_v_kr) != 0);
          if (__pyx_t_22) {

            /* "NNPS_Prototype.pyx":66
 * 
 *                     if y_dist > kr:
 *                         periodic_ydist = y_dist - y_max + y_min - dp             # <<<<<<<<<<<<<<
 * 
 ...
 */
            __pyx_v_periodic_ydist = (((__pyx_v_y_dist - __pyx_v_y_max) + __pyx_v_y_min) - __pyx_v_dp);

            /* "NNPS_Prototype.pyx":68
 *                         periodic_ydist = y_dist - y_max + y_min - dp
 * 
 *                         if abs(periodic_ydist) >= y_dist:             # <<<<<<<<<<<<<<
 ...
 * 
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_ydist) >= __pyx_v_y_dist) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":69
 * 
 *                         if abs(periodic_ydist) >= y_dist:
 *                             periodic_ydist = y_dist             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_v_periodic_ydist = __pyx_v_y_dist;
 ...
 * 
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_ydist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":72
 * 
 *                         if abs(periodic_ydist) <= kr + tol:
 *                             r_ijy = periodic_ydist             # <<<<<<<<<<<<<<
 * 
 *                 # =========================================== Z-Coordinate =============================================
 */
              __pyx_v_r_ijy = __pyx_v_periodic_ydist;
 ...
 * 
 */
        __pyx_t_22 = ((__pyx_v_pbc_z == 1) != 0);
        if (__pyx_t_22) {

          /* "NNPS_Prototype.pyx":77
 * 
 *                 if pbc_z == 1:
 *                     z_dist = abs(r_ijz)             # <<<<<<<<<<<<<<
 * 
 *                     if z_dist > kr:
 */
          __pyx_v_z_dist = fabs(__pyx_v_r_ijz);

          /* "NNPS_Prototype.pyx":79
 *                     z_dist = abs(r_ijz)
 * 
 *                     if z_dist > kr:             # <<<<<<<<<<<<<<
 ...
 * 
 */
          __pyx_t_22 = ((__pyx_v_z_dist > __pyx_v_kr) != 0);
          if (__pyx_t_22) {

            /* "NNPS_Prototype.pyx":80
 * 
 *                     if z_dist > kr:
 *                         periodic_zdist = z_dist - z_max + z_min - dp             # <<<<<<<<<<<<<<
 * 
 ...
 */
            __pyx_v_periodic_zdist = (((__pyx_v_z_dist - __pyx_v_z_max) + __pyx_v_z_min) - __pyx_v_dp);

            /* "NNPS_Prototype.pyx":82
 *                         periodic_zdist = z_dist - z_max + z_min - dp
 * 
 *                         if abs(periodic_zdist) >= z_dist:             # <<<<<<<<<<<<<<
 ...
 * 
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_zdist) >= __pyx_v_z_dist) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":83
 * 
 *                         if abs(periodic_zdist) >= z_dist:
 *                             periodic_zdist = z_dist             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_v_periodic_zdist = __pyx_v_z_dist;
 ...
 * 
 */
            __pyx_t_22 = ((fabs(__pyx_v_periodic_zdist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
            if (__pyx_t_22) {

              /* "NNPS_Prototype.pyx":86
 * 
 *                         if abs(periodic_zdist) <= kr + tol:
 *                             r_ijz = periodic_zdist             # <<<<<<<<<<<<<<
 * 
 *     # ==================================================================================================================
 */
              __pyx_v_r_ijz = __pyx_v_periodic_zdist;
 ...
 */
      __pyx_v_rij = sqrt((((__pyx_v_r_ijx * __pyx_v_r_ijx) + (__pyx_v_r_ijy * __pyx_v_r_ijy)) + (__pyx_v_r_ijz * __pyx_v_r_ijz)));

      /* "NNPS_Prototype.pyx":94
 * 
 *             # Find particles that are neighbors and add information to the corresponding arrays.
 *             if rij <= kr + tol:             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_22 = ((__pyx_v_rij <= (__pyx_v_kr + __pyx_v_tol)) != 0);
      if (__pyx_t_22) {

        /* "NNPS_Prototype.pyx":97
 * 
 *                 # Number of neighbor pairs and neighbor pairs arrays
 *                 ipn += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_ipn = (__pyx_v_ipn + 1);

        /* "NNPS_Prototype.pyx":100
 * 
 *                 # Test for size of the trial ipn_pairs array.
 *                 if ipn == trial_size:             # <<<<<<<<<<<<<<
 *                     undersized = 1
 *                     break
 */
        __pyx_t_22 = ((__pyx_v_ipn == __pyx_v_trial_size) != 0);
        if (__pyx_t_22) {

          /* "NNPS_Prototype.pyx":101
 *                 # Test for size of the trial ipn_pairs array.
 *                 if ipn == trial_size:
 *                     undersized = 1             # <<<<<<<<<<<<<<
 *                     break
 * 
 */
          __pyx_v_undersized = 1;

          /* "NNPS_Prototype.pyx":102
 *                 if ipn == trial_size:
 *                     undersized = 1
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_t_23 = __pyx_v_ipn;
        __pyx_t_24 = 0;
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_ipn_pairs.data + __pyx_t_23 * __pyx_v_ipn_pairs.strides[0]) )) + __pyx_t_24)) )) = __pyx_v_part_i;

        /* "NNPS_Prototype.pyx":105
 * 
 *                 ipn_pairs[ipn, 0] = part_i
 *                 ipn_pairs[ipn, 1] = part_j             # <<<<<<<<<<<<<<
 * 
 *         if undersized == 1:
 */
        __pyx_t_25 = __pyx_v_ipn;
        __pyx_t_26 = 1;
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_ipn_pairs.data + __pyx_t_25 * __pyx_v_ipn_pairs.strides[0]) )) + __pyx_t_26)) )) = __pyx_v_part_j;
 ...
 * 
 */
    __pyx_t_22 = ((__pyx_v_undersized == 1) != 0);
    if (__pyx_t_22) {

      /* "NNPS_Prototype.pyx":108
 * 
 *         if undersized == 1:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_t, __pyx_n_s_toc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_long(__pyx_v_ipn); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_undersized); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_AddTraceback("NNPS_Prototype.direct_search", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_14NNPS_Prototype_1direct_search(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14NNPS_Prototype_1direct_search(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_num_parts;
  double __pyx_v_h;
  double __pyx_v_dp;
  int __pyx_v_sim_dim;
  ...
  int __pyx_v_pbc_y;
  int __pyx_v_pbc_z;
  __Pyx_memviewslice __pyx_v_ipn_pairs = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_trial_size;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("direct_search (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r,&__pyx_n_s_num_parts,&__pyx_n_s_h,&__pyx_n_s_dp,&__pyx_n_s_sim_dim,&__pyx_n_s_x_min,&__pyx_n_s_x_max,&__pyx_n_s_y_min,&__pyx_n_s_y_max,&__pyx_n_s_z_min,&__pyx_n_s_z_max,&__pyx_n_s_pbc,&__pyx_n_s_pbc_x,&__pyx_n_s_pbc_y,&__pyx_n_s_pbc_z,&__pyx_n_s_ipn_pairs,&__pyx_n_s_trial_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_parts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 3); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sim_dim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 4); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 5); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 6); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 7); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 8); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 9); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 10); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 11); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 12); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 13); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 14); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 15:
        if (likely((values[15] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ipn_pairs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 15); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 16:
        if (likely((values[16] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_trial_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, 16); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "direct_search") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_num_parts = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_num_parts == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_h = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_dp = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_dp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_sim_dim = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_sim_dim == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_x_min = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_x_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_x_max = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_x_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_y_min = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_y_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_y_max = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_y_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_z_min = __pyx_PyFloat_AsDouble(values[9]); if (unlikely((__pyx_v_z_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_z_max = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_z_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_pbc = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_pbc == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_pbc_x = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_pbc_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_pbc_y = __Pyx_PyInt_As_int(values[13]); if (unlikely((__pyx_v_pbc_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_pbc_z = __Pyx_PyInt_As_int(values[14]); if (unlikely((__pyx_v_pbc_z == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_ipn_pairs = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[15], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ipn_pairs.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_trial_size = __Pyx_PyInt_As_int(values[16]); if (unlikely((__pyx_v_trial_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("direct_search", 1, 17, 17, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("NNPS_Prototype.direct_search", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14NNPS_Prototype_direct_search(__pyx_self, __pyx_v_r, __pyx_v_num_parts, __pyx_v_h, __pyx_v_dp, __pyx_v_sim_dim, __pyx_v_x_min, __pyx_v_x_max, __pyx_v_y_min, __pyx_v_y_max, __pyx_v_z_min, __pyx_v_z_max, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z, __pyx_v_ipn_pairs, __pyx_v_trial_size);
...
static PyObject *__pyx_pf_14NNPS_Prototype_direct_search(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, long __pyx_v_num_parts, double __pyx_v_h, double __pyx_v_dp, int __pyx_v_sim_dim, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size) {
  ...
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("direct_search", 0);
  __Pyx_TraceCall("direct_search (wrapper)", __pyx_f[0], 12, 0, __PYX_ERR(0, 12, __pyx_L1_error));
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 12, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ipn_pairs.memview)) { __Pyx_RaiseUnboundLocalError("ipn_pairs"); __PYX_ERR(0, 12, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14NNPS_Prototype_direct_search(__pyx_v_r, __pyx_v_num_parts, __pyx_v_h, __pyx_v_dp, __pyx_v_sim_dim, __pyx_v_x_min, __pyx_v_x_max, __pyx_v_y_min, __pyx_v_y_max, __pyx_v_z_min, __pyx_v_z_max, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z, __pyx_v_ipn_pairs, __pyx_v_trial_size, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_ipn_pairs, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_pw_14NNPS_Prototype_3create_grid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14NNPS_Prototype_create_grid(int __pyx_v_num_cols, int __pyx_v_num_rows, int __pyx_v_num_layers, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, double __pyx_v_x_max, double __pyx_v_y_max, double __pyx_v_z_max, double __pyx_v_dp, double __pyx_v_h, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_row;
  int __pyx_v_col;
  int __pyx_v_lay;
  int __pyx_v_row2;
  ...
  int __pyx_v_min_row;
  int __pyx_v_max_row;
  int __pyx_v_min_layer;
  int __pyx_v_max_layer;
  int __pyx_v_neigh_cell_num;
  int __pyx_v_pos;
  ...
  __Pyx_RefNannySetupContext("create_grid", 0);

  /* "NNPS_Prototype.pyx":130
 *         int cols[4]
 *         int layers[4]
 *         double kr = 2 * h             # <<<<<<<<<<<<<<
 *         double tol = 0.501 *  dp
 ...
 */
  __pyx_v_tol = (0.501 * __pyx_v_dp);

  /* "NNPS_Prototype.pyx":134
 * 
 *     # This loop runs through all cells' indices.
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_lay = __pyx_t_3;

    /* "NNPS_Prototype.pyx":135
 *     # This loop runs through all cells' indices.
 *     for lay in range(num_layers):
 *         for row in range(num_rows):             # <<<<<<<<<<<<<<
 *             for col in range(num_cols):
 ...
 */
        __pyx_v_cell_num = (((__pyx_v_col + (__pyx_v_row * __pyx_v_num_cols)) + ((__pyx_v_lay * __pyx_v_num_cols) * __pyx_v_num_rows)) + 1);

        /* "NNPS_Prototype.pyx":142
 *                 # Read indices of neighbor cells, such that it can only read forward cells (which means, does not
 ...
 *                 min_row = row - 1
 */
        __pyx_v_min_col = (__pyx_v_col - 1);

        /* "NNPS_Prototype.pyx":143
 *                 #  consider a cell with lower index).
 *                 min_col = col - 1
 *                 max_col = col + 1             # <<<<<<<<<<<<<<
 *                 min_row = row - 1
 *                 max_row = row + 1
 */
        __pyx_v_max_col = (__pyx_v_col + 1);

        /* "NNPS_Prototype.pyx":144
 *                 min_col = col - 1
 *                 max_col = col + 1
 *                 min_row = row - 1             # <<<<<<<<<<<<<<
 *                 max_row = row + 1
 *                 min_layer = lay - 1
 */
        __pyx_v_min_row = (__pyx_v_row - 1);

        /* "NNPS_Prototype.pyx":145
 *                 max_col = col + 1
 *                 min_row = row - 1
 *                 max_row = row + 1             # <<<<<<<<<<<<<<
 *                 min_layer = lay - 1
 *                 max_layer = lay + 1
 */
        __pyx_v_max_row = (__pyx_v_row + 1);

        /* "NNPS_Prototype.pyx":146
 *                 min_row = row - 1
 *                 max_row = row + 1
 *                 min_layer = lay - 1             # <<<<<<<<<<<<<<
 *                 max_layer = lay + 1
 * 
 */
        __pyx_v_min_layer = (__pyx_v_lay - 1);

        /* "NNPS_Prototype.pyx":147
 *                 max_row = row + 1
 *                 min_layer = lay - 1
 *                 max_layer = lay + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_max_layer = (__pyx_v_lay + 1);

        /* "NNPS_Prototype.pyx":150
 * 
 *                 # Adjust the indices within the correct range for corner or edge cells.
 *                 if min_col < 0:             # <<<<<<<<<<<<<<
 *                     min_col = 0
 ...
 */
        __pyx_t_10 = ((__pyx_v_min_col < 0) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":151
 *                 # Adjust the indices within the correct range for corner or edge cells.
 *                 if min_col < 0:
 *                     min_col = 0             # <<<<<<<<<<<<<<
 *                 if max_col + 1 > num_cols:
 ...
 * 
 */
        __pyx_t_10 = (((__pyx_v_max_col + 1) > __pyx_v_num_cols) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":153
 *                     min_col = 0
 *                 if max_col + 1 > num_cols:
 *                     max_col = col             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_10 = ((__pyx_v_min_row < 0) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":156
 * 
 *                 if min_row < 0:
 *                     min_row = 0             # <<<<<<<<<<<<<<
 *                 if max_row + 1 > num_rows:
 ...
 * 
 */
        __pyx_t_10 = (((__pyx_v_max_row + 1) > __pyx_v_num_rows) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":158
 *                     min_row = 0
 *                 if max_row + 1 > num_rows:
 *                     max_row = row             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_10 = ((__pyx_v_min_layer < 0) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":161
 * 
 *                 if min_layer < 0:
 *                     min_layer = 0             # <<<<<<<<<<<<<<
 *                 if max_layer + 1 > num_layers:
 ...
 * 
 */
        __pyx_t_10 = (((__pyx_v_max_layer + 1) > __pyx_v_num_layers) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":163
 *                     min_layer = 0
 *                 if max_layer + 1 > num_layers:
 *                     max_layer = lay             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_10 = ((__pyx_v_pbc == 0) != 0);
        if (__pyx_t_10) {

          /* "NNPS_Prototype.pyx":168
 * 
 *                     # This loop is to find for each cell, its neighbors.
 *                     pos = 0             # <<<<<<<<<<<<<<
 ...
 */
          __pyx_t_11 = (__pyx_v_max_layer + 1);
          __pyx_t_12 = __pyx_t_11;
          for (__pyx_t_13 = __pyx_v_min_layer; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
            __pyx_v_lay2 = __pyx_t_13;

            /* "NNPS_Prototype.pyx":170
 *                     pos = 0
 *                     for lay2 in range(min_layer, max_layer + 1):
 *                         for row2 in range(min_row, max_row + 1):             # <<<<<<<<<<<<<<
 *                             for col2 in range(min_col, max_col + 1):
 * 
 */
            __pyx_t_14 = (__pyx_v_max_row + 1);
            __pyx_t_15 = __pyx_t_14;
            for (__pyx_t_16 = __pyx_v_min_row; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
              __pyx_v_row2 = __pyx_t_16;

              /* "NNPS_Prototype.pyx":171
 *                     for lay2 in range(min_layer, max_layer + 1):
 *                         for row2 in range(min_row, max_row + 1):
 *                             for col2 in range(min_col, max_col + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_t_17 = (__pyx_v_max_col + 1);
              __pyx_t_18 = __pyx_t_17;
              for (__pyx_t_19 = __pyx_v_min_col; __pyx_t_19 < __pyx_t_18; __pyx_t_19+=1) {
                __pyx_v_col2 = __pyx_t_19;

                /* "NNPS_Prototype.pyx":173
 *                             for col2 in range(min_col, max_col + 1):
 * 
 *                                 neigh_cell_num = col2 + row2 * num_cols + lay2 * num_cols * num_rows + 1             # <<<<<<<<<<<<<<
 ...
 *                                 pos +=1
 */
                __pyx_v_neigh_cell_num = (((__pyx_v_col2 + (__pyx_v_row2 * __pyx_v_num_cols)) + ((__pyx_v_lay2 * __pyx_v_num_cols) * __pyx_v_num_rows)) + 1);

                /* "NNPS_Prototype.pyx":174
 * 
 *                                 neigh_cell_num = col2 + row2 * num_cols + lay2 * num_cols * num_rows + 1
 *                                 grid[cell_num, pos] = neigh_cell_num             # <<<<<<<<<<<<<<
 *                                 pos +=1
 ...
 */
                ...
                *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_20 * __pyx_v_grid.strides[0]) )) + __pyx_t_21)) )) = __pyx_v_neigh_cell_num;

                /* "NNPS_Prototype.pyx":175
 *                                 neigh_cell_num = col2 + row2 * num_cols + lay2 * num_cols * num_rows + 1
 *                                 grid[cell_num, pos] = neigh_cell_num
 *                                 pos +=1             # <<<<<<<<<<<<<<
 * 
 ...
 *                         cols[0] = min_col
 */
          __pyx_t_22 = ((__pyx_v_col == 0) != 0);
          if (!__pyx_t_22) {
          } else {
            __pyx_t_10 = __pyx_t_22;
            goto __pyx_L23_bool_binop_done;
          }
          __pyx_t_22 = ((__pyx_v_col == (__pyx_v_num_cols - 1)) != 0);
          __pyx_t_10 = __pyx_t_22;
          __pyx_L23_bool_binop_done:;
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":188
 *                     #  layers in the PBC loop.
 *                     if col == 0 or col == num_cols - 1:
 *                         col_idx = 2             # <<<<<<<<<<<<<<
 *                         cols[0] = min_col
 ...
 *                     else:
 */
            (__pyx_v_cols[0]) = __pyx_v_min_col;

            /* "NNPS_Prototype.pyx":190
 *                         col_idx = 2
 *                         cols[0] = min_col
 *                         cols[1] = max_col             # <<<<<<<<<<<<<<
 *                     else:
 *                         col_idx = 3
 */
            (__pyx_v_cols[1]) = __pyx_v_max_col;
 ...
 *                         cols[2] = col + 1
 */
            (__pyx_v_cols[0]) = (__pyx_v_col - 1);

            /* "NNPS_Prototype.pyx":194
 *                         col_idx = 3
 *                         cols[0] = col - 1
 *                         cols[1] = col             # <<<<<<<<<<<<<<
 *                         cols[2] = col + 1
 * 
 */
            (__pyx_v_cols[1]) = __pyx_v_col;

            /* "NNPS_Prototype.pyx":195
 *                         cols[0] = col - 1
 *                         cols[1] = col
 *                         cols[2] = col + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
            (__pyx_v_cols[2]) = (__pyx_v_col + 1);
          }
          __pyx_L22:;

          /* "NNPS_Prototype.pyx":197
 *                         cols[2] = col + 1
 * 
 *                     if row == 0 or row == num_rows - 1:             # <<<<<<<<<<<<<<
 *                         row_idx = 2
 *                         rows[0] = min_row
 */
          __pyx_t_22 = ((__pyx_v_row == 0) != 0);
          if (!__pyx_t_22) {
          } else {
            __pyx_t_10 = __pyx_t_22;
            goto __pyx_L26_bool_binop_done;
          }
          __pyx_t_22 = ((__pyx_v_row == (__pyx_v_num_rows - 1)) != 0);
          __pyx_t_10 = __pyx_t_22;
          __pyx_L26_bool_binop_done:;
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":198
 * 
 *                     if row == 0 or row == num_rows - 1:
 *                         row_idx = 2             # <<<<<<<<<<<<<<
 *                         rows[0] = min_row
 ...
 *                     else:
 */
            (__pyx_v_rows[0]) = __pyx_v_min_row;

            /* "NNPS_Prototype.pyx":200
 *                         row_idx = 2
 *                         rows[0] = min_row
 *                         rows[1] = max_row             # <<<<<<<<<<<<<<
 *                     else:
 *                         row_idx = 3
 */
            (__pyx_v_rows[1]) = __pyx_v_max_row;
 ...
 *                         rows[2] = row + 1
 */
            (__pyx_v_rows[0]) = (__pyx_v_row - 1);

            /* "NNPS_Prototype.pyx":204
 *                         row_idx = 3
 *                         rows[0] = row - 1
 *                         rows[1] = row             # <<<<<<<<<<<<<<
 *                         rows[2] = row + 1
 * 
 */
            (__pyx_v_rows[1]) = __pyx_v_row;

            /* "NNPS_Prototype.pyx":205
 *                         rows[0] = row - 1
 *                         rows[1] = row
 *                         rows[2] = row + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
            (__pyx_v_rows[2]) = (__pyx_v_row + 1);
          }
          __pyx_L25:;

          /* "NNPS_Prototype.pyx":207
 *                         rows[2] = row + 1
 * 
 *                     if lay == 0 or lay == num_layers - 1:             # <<<<<<<<<<<<<<
 *                         lay_idx = 2
 *                         layers[0] = min_layer
 */
          __pyx_t_22 = ((__pyx_v_lay == 0) != 0);
          if (!__pyx_t_22) {
          } else {
            __pyx_t_10 = __pyx_t_22;
            goto __pyx_L29_bool_binop_done;
          }
          __pyx_t_22 = ((__pyx_v_lay == (__pyx_v_num_layers - 1)) != 0);
          __pyx_t_10 = __pyx_t_22;
          __pyx_L29_bool_binop_done:;
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":208
 * 
 *                     if lay == 0 or lay == num_layers - 1:
 *                         lay_idx = 2             # <<<<<<<<<<<<<<
 *                         layers[0] = min_layer
 ...
 *                     else:
 */
            (__pyx_v_layers[0]) = __pyx_v_min_layer;

            /* "NNPS_Prototype.pyx":210
 *                         lay_idx = 2
 *                         layers[0] = min_layer
 *                         layers[1] = max_layer             # <<<<<<<<<<<<<<
 *                     else:
 *                         lay_idx = 3
 */
            (__pyx_v_layers[1]) = __pyx_v_max_layer;
 ...
 *                         layers[2] = lay + 1
 */
            (__pyx_v_layers[0]) = (__pyx_v_lay - 1);

            /* "NNPS_Prototype.pyx":214
 *                         lay_idx = 3
 *                         layers[0] = lay - 1
 *                         layers[1] = lay             # <<<<<<<<<<<<<<
 *                         layers[2] = lay + 1
 * 
 */
            (__pyx_v_layers[1]) = __pyx_v_lay;

            /* "NNPS_Prototype.pyx":215
 *                         layers[0] = lay - 1
 *                         layers[1] = lay
 *                         layers[2] = lay + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
            (__pyx_v_layers[2]) = (__pyx_v_lay + 1);
          }
          __pyx_L28:;

          /* "NNPS_Prototype.pyx":219
 *                     # Adjust range for the case when one of the dimensions is unity, or in case one or more directions
 *                     #  are not periodic.
 *                     if num_cols == 1:             # <<<<<<<<<<<<<<
 *                         col_idx = 1
 *                         cols[0] = 0
 */
          __pyx_t_10 = ((__pyx_v_num_cols == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":220
 *                     #  are not periodic.
 *                     if num_cols == 1:
 *                         col_idx = 1             # <<<<<<<<<<<<<<
 *                         cols[0] = 0
 ...
 *                         rows[0] = 0
 */
          __pyx_t_10 = ((__pyx_v_num_rows == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":224
 * 
 *                     if num_rows == 1:
 *                         row_idx = 1             # <<<<<<<<<<<<<<
 *                         rows[0] = 0
 ...
 *                         layers[0] = 0
 */
          __pyx_t_10 = ((__pyx_v_num_layers == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":228
 * 
 *                     if num_layers == 1:
 *                         lay_idx = 1             # <<<<<<<<<<<<<<
 *                         layers[0] = 0
 ...
 * 
 */
          __pyx_t_10 = ((__pyx_v_pbc_x == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":234
 *                     #  cases only apply to the very first, second to last, or last rows, columns, or layers.
 *                     if pbc_x == 1:
 *                         col_idx = 3             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 col_idx = 4
 */
            __pyx_t_10 = (((__pyx_v_num_cols * __pyx_v_kr) > (__pyx_v_x_max + __pyx_v_tol)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":237
 * 
 *                         if num_cols * kr > x_max + tol:
 *                             if col == 0:             # <<<<<<<<<<<<<<
 *                                 col_idx = 4
 *                                 cols[2] = num_cols - 2
 */
              __pyx_t_10 = ((__pyx_v_col == 0) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":238
 *                         if num_cols * kr > x_max + tol:
 *                             if col == 0:
 *                                 col_idx = 4             # <<<<<<<<<<<<<<
 *                                 cols[2] = num_cols - 2
 ...
 *                             elif col == num_cols - 2:
 */
                (__pyx_v_cols[2]) = (__pyx_v_num_cols - 2);

                /* "NNPS_Prototype.pyx":240
 *                                 col_idx = 4
 *                                 cols[2] = num_cols - 2
 *                                 cols[3] = num_cols - 1             # <<<<<<<<<<<<<<
 *                             elif col == num_cols - 2:
 *                                 col_idx = 4
 */
                (__pyx_v_cols[3]) = (__pyx_v_num_cols - 1);
 ...
 *                                 cols[0] = 0
 */
              __pyx_t_10 = ((__pyx_v_col == (__pyx_v_num_cols - 2)) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":242
 *                                 cols[3] = num_cols - 1
 *                             elif col == num_cols - 2:
 *                                 col_idx = 4             # <<<<<<<<<<<<<<
 *                                 cols[0] = 0
 ...
 *                                 cols[3] = col + 1
 */
                (__pyx_v_cols[1]) = (__pyx_v_col - 1);

                /* "NNPS_Prototype.pyx":245
 *                                 cols[0] = 0
 *                                 cols[1] = col - 1
 *                                 cols[2] = col             # <<<<<<<<<<<<<<
 *                                 cols[3] = col + 1
 * 
 */
                (__pyx_v_cols[2]) = __pyx_v_col;

                /* "NNPS_Prototype.pyx":246
 *                                 cols[1] = col - 1
 *                                 cols[2] = col
 *                                 cols[3] = col + 1             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 cols[0] = col - 1
 */
                (__pyx_v_cols[2]) = (__pyx_v_num_cols - 1);
 ...
 *                             cols[1] = col - 1
 */
            __pyx_t_10 = ((__pyx_v_col == (__pyx_v_num_cols - 1)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":259
 * 
 *                         if col == num_cols - 1:
 *                             cols[0] = 0             # <<<<<<<<<<<<<<
 *                             cols[1] = col - 1
 ...
 * 
 */
          __pyx_t_10 = ((__pyx_v_pbc_y == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":264
 * 
 *                     if pbc_y == 1:
 *                         row_idx = 3             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 row_idx = 4
 */
            __pyx_t_10 = (((__pyx_v_num_rows * __pyx_v_kr) > (__pyx_v_y_max + __pyx_v_tol)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":267
 * 
 *                         if num_rows * kr > y_max + tol:
 *                             if row == 0:             # <<<<<<<<<<<<<<
 *                                 row_idx = 4
 *                                 rows[2] = num_rows - 2
 */
              __pyx_t_10 = ((__pyx_v_row == 0) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":268
 *                         if num_rows * kr > y_max + tol:
 *                             if row == 0:
 *                                 row_idx = 4             # <<<<<<<<<<<<<<
 *                                 rows[2] = num_rows - 2
 ...
 *                             elif row == num_rows - 2:
 */
                (__pyx_v_rows[2]) = (__pyx_v_num_rows - 2);

                /* "NNPS_Prototype.pyx":270
 *                                 row_idx = 4
 *                                 rows[2] = num_rows - 2
 *                                 rows[3] = num_rows - 1             # <<<<<<<<<<<<<<
 *                             elif row == num_rows - 2:
 *                                 row_idx = 4
 */
                (__pyx_v_rows[3]) = (__pyx_v_num_rows - 1);
 ...
 *                                 rows[0] = 0
 */
              __pyx_t_10 = ((__pyx_v_row == (__pyx_v_num_rows - 2)) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":272
 *                                 rows[3] = num_rows - 1
 *                             elif row == num_rows - 2:
 *                                 row_idx = 4             # <<<<<<<<<<<<<<
 *                                 rows[0] = 0
 ...
 *                                 rows[3] = row + 1
 */
                (__pyx_v_rows[1]) = (__pyx_v_row - 1);

                /* "NNPS_Prototype.pyx":275
 *                                 rows[0] = 0
 *                                 rows[1] = row - 1
 *                                 rows[2] = row             # <<<<<<<<<<<<<<
 *                                 rows[3] = row + 1
 * 
 */
                (__pyx_v_rows[2]) = __pyx_v_row;

                /* "NNPS_Prototype.pyx":276
 *                                 rows[1] = row - 1
 *                                 rows[2] = row
 *                                 rows[3] = row + 1             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 rows[0] = row - 1
 */
                (__pyx_v_rows[2]) = (__pyx_v_num_rows - 1);
 ...
 *                             rows[1] = row - 1
 */
            __pyx_t_10 = ((__pyx_v_row == (__pyx_v_num_rows - 1)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":289
 * 
 *                         if row == num_rows - 1:
 *                             rows[0] = 0             # <<<<<<<<<<<<<<
 *                             rows[1] = row - 1
 ...
 * 
 */
          __pyx_t_10 = ((__pyx_v_pbc_z == 1) != 0);
          if (__pyx_t_10) {

            /* "NNPS_Prototype.pyx":294
 * 
 *                     if pbc_z == 1:
 *                         lay_idx = 3             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 lay_idx = 4
 */
            __pyx_t_10 = (((__pyx_v_num_layers * __pyx_v_kr) > (__pyx_v_z_max + __pyx_v_tol)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":297
 * 
 *                         if num_layers * kr > z_max + tol:
 *                             if lay == 0:             # <<<<<<<<<<<<<<
 *                                 lay_idx = 4
 ...
 */
              __pyx_t_10 = ((__pyx_v_lay == 0) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":298
 *                         if num_layers * kr > z_max + tol:
 *                             if lay == 0:
 *                                 lay_idx = 4             # <<<<<<<<<<<<<<
 *                                 layers[2] = num_layers - 2
 ...
 */
                (__pyx_v_layers[2]) = (__pyx_v_num_layers - 2);

                /* "NNPS_Prototype.pyx":300
 *                                 lay_idx = 4
 *                                 layers[2] = num_layers - 2
 *                                 layers[3] = num_layers - 1             # <<<<<<<<<<<<<<
 *                             elif lay == num_layers - 2:
 *                                 lay_idx = 4
 */
                (__pyx_v_layers[3]) = (__pyx_v_num_layers - 1);
 ...
 *                                 layers[0] = 0
 */
              __pyx_t_10 = ((__pyx_v_lay == (__pyx_v_num_layers - 2)) != 0);
              if (__pyx_t_10) {

                /* "NNPS_Prototype.pyx":302
 *                                 layers[3] = num_layers - 1
 *                             elif lay == num_layers - 2:
 *                                 lay_idx = 4             # <<<<<<<<<<<<<<
 *                                 layers[0] = 0
 ...
 *                                 layers[3] = lay + 1
 */
                (__pyx_v_layers[1]) = (__pyx_v_lay - 1);

                /* "NNPS_Prototype.pyx":305
 *                                 layers[0] = 0
 *                                 layers[1] = lay - 1
 *                                 layers[2] = lay             # <<<<<<<<<<<<<<
 *                                 layers[3] = lay + 1
 * 
 */
                (__pyx_v_layers[2]) = __pyx_v_lay;

                /* "NNPS_Prototype.pyx":306
 *                                 layers[1] = lay - 1
 *                                 layers[2] = lay
 *                                 layers[3] = lay + 1             # <<<<<<<<<<<<<<
 * 
 *                         else:
 */
                (__pyx_v_layers[3]) = (__pyx_v_lay + 1);
 ...
 *                                 layers[0] = lay - 1
 */
                (__pyx_v_layers[2]) = (__pyx_v_num_layers - 1);
 ...
 *                             layers[1] = lay - 1
 */
            __pyx_t_10 = ((__pyx_v_lay == (__pyx_v_num_layers - 1)) != 0);
            if (__pyx_t_10) {

              /* "NNPS_Prototype.pyx":319
 * 
 *                         if lay == num_layers - 1:
 *                             layers[0] = 0             # <<<<<<<<<<<<<<
 *                             layers[1] = lay - 1
 ...
 * 
 */
            __pyx_t_23 = __pyx_v_row_idx;
            __pyx_t_24 = __pyx_t_23;
            for (__pyx_t_25 = 0; __pyx_t_25 < __pyx_t_24; __pyx_t_25+=1) {
              __pyx_v_row2 = __pyx_t_25;

              /* "NNPS_Prototype.pyx":327
 *                     for lay2 in range(lay_idx):
 *                         for row2 in range(row_idx):
 *                             for col2 in range(col_idx):             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              for (__pyx_t_28 = 0; __pyx_t_28 < __pyx_t_27; __pyx_t_28+=1) {
                __pyx_v_col2 = __pyx_t_28;

                /* "NNPS_Prototype.pyx":330
 * 
 *                                 neigh_cell_num = cols[col2] + rows[row2] * num_cols + layers[lay2] * num_cols * \
 *                                                  num_rows + 1             # <<<<<<<<<<<<<<
 *                                 grid[cell_num, pos] = neigh_cell_num
 *                                 pos +=1
 */
                __pyx_v_neigh_cell_num = ((((__pyx_v_cols[__pyx_v_col2]) + ((__pyx_v_rows[__pyx_v_row2]) * __pyx_v_num_cols)) + (((__pyx_v_layers[__pyx_v_lay2]) * __pyx_v_num_cols) * __pyx_v_num_rows)) + 1);

                /* "NNPS_Prototype.pyx":331
 *                                 neigh_cell_num = cols[col2] + rows[row2] * num_cols + layers[lay2] * num_cols * \
 *                                                  num_rows + 1
 *                                 grid[cell_num, pos] = neigh_cell_num             # <<<<<<<<<<<<<<
 *                                 pos +=1
 * 
 */
                __pyx_t_29 = __pyx_v_cell_num;
                __pyx_t_30 = __pyx_v_pos;
                *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_29 * __pyx_v_grid.strides[0]) )) + __pyx_t_30)) )) = __pyx_v_neigh_cell_num;

                /* "NNPS_Prototype.pyx":332
 *                                                  num_rows + 1
 *                                 grid[cell_num, pos] = neigh_cell_num
 *                                 pos +=1             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_14NNPS_Prototype_3create_grid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14NNPS_Prototype_3create_grid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("create_grid (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_num_cols,&__pyx_n_s_num_rows,&__pyx_n_s_num_layers,&__pyx_n_s_grid,&__pyx_n_s_pbc,&__pyx_n_s_pbc_x,&__pyx_n_s_pbc_y,&__pyx_n_s_pbc_z,&__pyx_n_s_x_max,&__pyx_n_s_y_max,&__pyx_n_s_z_max,&__pyx_n_s_dp,&__pyx_n_s_h,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_cols)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_rows)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 1); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_layers)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 2); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 3); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 4); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 5); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 6); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 7); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 8); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 9); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 10); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 11); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, 12); __PYX_ERR(0, 121, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "create_grid") < 0)) __PYX_ERR(0, 121, __pyx_L3_error)
      }
    ...
    __pyx_v_num_cols = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_num_cols == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_num_rows = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_num_rows == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_num_layers = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_num_layers == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_pbc = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_pbc == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_pbc_x = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_pbc_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_pbc_y = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_pbc_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_pbc_z = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_pbc_z == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_x_max = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_x_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_y_max = __pyx_PyFloat_AsDouble(values[9]); if (unlikely((__pyx_v_y_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_z_max = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_z_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_dp = __pyx_PyFloat_AsDouble(values[11]); if (unlikely((__pyx_v_dp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_h = __pyx_PyFloat_AsDouble(values[12]); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("create_grid", 1, 13, 13, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 121, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("NNPS_Prototype.create_grid", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14NNPS_Prototype_2create_grid(__pyx_self, __pyx_v_num_cols, __pyx_v_num_rows, __pyx_v_num_layers, __pyx_v_grid, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z, __pyx_v_x_max, __pyx_v_y_max, __pyx_v_z_max, __pyx_v_dp, __pyx_v_h);
...
static PyObject *__pyx_pf_14NNPS_Prototype_2create_grid(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_cols, int __pyx_v_num_rows, int __pyx_v_num_layers, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, double __pyx_v_x_max, double __pyx_v_y_max, double __pyx_v_z_max, double __pyx_v_dp, double __pyx_v_h) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("create_grid", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_grid.memview)) { __Pyx_RaiseUnboundLocalError("grid"); __PYX_ERR(0, 121, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14NNPS_Prototype_create_grid(__pyx_v_num_cols, __pyx_v_num_rows, __pyx_v_num_layers, __pyx_v_grid, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z, __pyx_v_x_max, __pyx_v_y_max, __pyx_v_z_max, __pyx_v_dp, __pyx_v_h, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_14NNPS_Prototype_5allocate_particles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_14NNPS_Prototype_allocate_particles(__Pyx_memviewslice __pyx_v_r, int __pyx_v_num_cols, int __pyx_v_num_rows, CYTHON_UNUSED int __pyx_v_num_cells, double __pyx_v_h, int __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_parts_cells, double __pyx_v_dp, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_row;
  int __pyx_v_col;
  int __pyx_v_lay;
  int __pyx_v_part_cell_num;
  int __pyx_v_part;
  int __pyx_v_pos;
  ...
  Py_ssize_t __pyx_t_16;
  int __pyx_t_17;
  __Pyx_RefNannySetupContext("allocate_particles", 0);

  /* "NNPS_Prototype.pyx":344
 * 
 *     cdef:
 ...
 * 
 */
  __pyx_v_side = (2.0 * __pyx_v_h);

  /* "NNPS_Prototype.pyx":346
 *         int row, col, lay, part_cell_num, part, cell_num, pos, max_index = 0
 *         double x, y, z, side = 2 * h
 *         double tol = 0.001 * dp             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_5 = 0;
    __pyx_v_x = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_4 * __pyx_v_r.strides[0]) )) + __pyx_t_5)) )));

    /* "NNPS_Prototype.pyx":351
 *         # Particles coordinates.
 *         x = r[part, 0]
 *         y = r[part, 1]             # <<<<<<<<<<<<<<
 *         z = r[part, 2]
 * 
 */
    __pyx_t_6 = __pyx_v_part;
    __pyx_t_7 = 1;
    __pyx_v_y = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_6 * __pyx_v_r.strides[0]) )) + __pyx_t_7)) )));

    /* "NNPS_Prototype.pyx":352
 *         x = r[part, 0]
 *         y = r[part, 1]
 *         z = r[part, 2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_9 = 2;
    __pyx_v_z = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_8 * __pyx_v_r.strides[0]) )) + __pyx_t_9)) )));

    /* "NNPS_Prototype.pyx":355
 * 
 *         # Find the column, row and layer for each particle.
 *         col = <int>((x - tol) / side)             # <<<<<<<<<<<<<<
 *         row = <int>((y - tol) / side)
 *         lay = <int>((z - tol) / side)
 */
    __pyx_v_col = ((int)((__pyx_v_x - __pyx_v_tol) / __pyx_v_side));

    /* "NNPS_Prototype.pyx":356
 *         # Find the column, row and layer for each particle.
 *         col = <int>((x - tol) / side)
 *         row = <int>((y - tol) / side)             # <<<<<<<<<<<<<<
 *         lay = <int>((z - tol) / side)
 * 
 */
    __pyx_v_row = ((int)((__pyx_v_y - __pyx_v_tol) / __pyx_v_side));

    /* "NNPS_Prototype.pyx":357
 *         col = <int>((x - tol) / side)
 *         row = <int>((y - tol) / side)
 *         lay = <int>((z - tol) / side)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_lay = ((int)((__pyx_v_z - __pyx_v_tol) / __pyx_v_side));

    /* "NNPS_Prototype.pyx":360
 * 
 *         # Find the corresponding cell number for the particle and assign it to parts_cells.
 ...
 * 
 */
    __pyx_v_part_cell_num = (((__pyx_v_col + (__pyx_v_row * __pyx_v_num_cols)) + ((__pyx_v_lay * __pyx_v_num_cols) * __pyx_v_num_rows)) + 1);

    /* "NNPS_Prototype.pyx":361
 *         # Find the corresponding cell number for the particle and assign it to parts_cells.
 *         part_cell_num = col + row * num_cols + lay * num_cols * num_rows + 1
 *         parts_cells[part] = part_cell_num             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_parts_cells.data) + __pyx_t_10)) )) = __pyx_v_part_cell_num;

    /* "NNPS_Prototype.pyx":365
 *         # Assign the current particle to its corresponding cell. The index pos keeps track of the next position in the
 ...
 */
    __pyx_t_11 = __pyx_v_part_cell_num;
    __pyx_t_12 = 0;
    __pyx_v_pos = ((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_cells_parts.data + __pyx_t_11 * __pyx_v_cells_parts.strides[0]) )) + __pyx_t_12)) ))) + 1);

    /* "NNPS_Prototype.pyx":366
 *         #  array where to add the particle index.
 *         pos = cells_parts[part_cell_num, 0] + 1
 *         cells_parts[part_cell_num, pos] = part             # <<<<<<<<<<<<<<
 *         cells_parts[part_cell_num, 0] = pos
 * 
 */
    __pyx_t_13 = __pyx_v_part_cell_num;
    __pyx_t_14 = __pyx_v_pos;
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_cells_parts.data + __pyx_t_13 * __pyx_v_cells_parts.strides[0]) )) + __pyx_t_14)) )) = __pyx_v_part;

    /* "NNPS_Prototype.pyx":367
 *         pos = cells_parts[part_cell_num, 0] + 1
 *         cells_parts[part_cell_num, pos] = part
 *         cells_parts[part_cell_num, 0] = pos             # <<<<<<<<<<<<<<
 * 
 *         if pos > max_index:
 */
    __pyx_t_15 = __pyx_v_part_cell_num;
    __pyx_t_16 = 0;
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_cells_parts.data + __pyx_t_15 * __pyx_v_cells_parts.strides[0]) )) + __pyx_t_16)) )) = __pyx_v_pos;

    /* "NNPS_Prototype.pyx":369
 *         cells_parts[part_cell_num, 0] = pos
 * 
 *         if pos > max_index:             # <<<<<<<<<<<<<<
 *             max_index = pos
 * 
 */
    __pyx_t_17 = ((__pyx_v_pos > __pyx_v_max_index) != 0);
    if (__pyx_t_17) {

      /* "NNPS_Prototype.pyx":370
 * 
 *         if pos > max_index:
 *             max_index = pos             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_14NNPS_Prototype_5allocate_particles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14NNPS_Prototype_5allocate_particles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_num_cols;
  int __pyx_v_num_rows;
  ...
  __Pyx_memviewslice __pyx_v_cells_parts = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_parts_cells = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_dp;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("allocate_particles (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r,&__pyx_n_s_num_cols,&__pyx_n_s_num_rows,&__pyx_n_s_num_cells,&__pyx_n_s_h,&__pyx_n_s_num_parts,&__pyx_n_s_cells_parts,&__pyx_n_s_parts_cells,&__pyx_n_s_dp,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_cols)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 1); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_rows)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 2); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_cells)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 3); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 4); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_parts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 5); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cells_parts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 6); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_parts_cells)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 7); __PYX_ERR(0, 340, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, 8); __PYX_ERR(0, 340, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "allocate_particles") < 0)) __PYX_ERR(0, 340, __pyx_L3_error)
      }
    ...
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_num_cols = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_num_cols == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_num_rows = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_num_rows == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_num_cells = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num_cells == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_h = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_num_parts = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_num_parts == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 340, __pyx_L3_error)
    __pyx_v_cells_parts = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cells_parts.memview)) __PYX_ERR(0, 341, __pyx_L3_error)
    __pyx_v_parts_cells = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_parts_cells.memview)) __PYX_ERR(0, 341, __pyx_L3_error)
    __pyx_v_dp = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_dp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 341, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("allocate_particles", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 340, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("NNPS_Prototype.allocate_particles", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14NNPS_Prototype_4allocate_particles(__pyx_self, __pyx_v_r, __pyx_v_num_cols, __pyx_v_num_rows, __pyx_v_num_cells, __pyx_v_h, __pyx_v_num_parts, __pyx_v_cells_parts, __pyx_v_parts_cells, __pyx_v_dp);
...
static PyObject *__pyx_pf_14NNPS_Prototype_4allocate_particles(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, int __pyx_v_num_cols, int __pyx_v_num_rows, int __pyx_v_num_cells, double __pyx_v_h, int __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_parts_cells, double __pyx_v_dp) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("allocate_particles", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 340, __pyx_L1_error) }
  if (unlikely(!__pyx_v_cells_parts.memview)) { __Pyx_RaiseUnboundLocalError("cells_parts"); __PYX_ERR(0, 340, __pyx_L1_error) }
  if (unlikely(!__pyx_v_parts_cells.memview)) { __Pyx_RaiseUnboundLocalError("parts_cells"); __PYX_ERR(0, 340, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_14NNPS_Prototype_allocate_particles(__pyx_v_r, __pyx_v_num_cols, __pyx_v_num_rows, __pyx_v_num_cells, __pyx_v_h, __pyx_v_num_parts, __pyx_v_cells_parts, __pyx_v_parts_cells, __pyx_v_dp, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 340, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_r, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cells_parts, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_parts_cells, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "NNPS_Prototype.pyx":377
 * @boundscheck(False)
 * @wraparound(False)
...
static PyObject *__pyx_pw_14NNPS_Prototype_7linked_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_14NNPS_Prototype_linked_list(__Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_parts_cells, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_grid, double __pyx_v_h, double __pyx_v_dp, CYTHON_UNUSED int __pyx_v_sim_dim, long __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_t = NULL;
  int __pyx_v_undersized;
  long __pyx_v_part_i;
  long __pyx_v_part_j;
  long __pyx_v_neighbor_cell;
  long __pyx_v_cell_num;
  long __pyx_v_i;
  long __pyx_v_j;
  long __pyx_v_ipn_init;
  long __pyx_v_ipn;
  double __pyx_v_kr;
  double __pyx_v_tol;
  double __pyx_v_r_ijx;
  ...
  double __pyx_v_periodic_ydist;
  double __pyx_v_periodic_zdist;
  __Pyx_memviewslice __pyx_v_cell_neighbors = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_neighbor_parts = { 0, 0, { 0 }, { 0 }, { 0 } };
 ...
 *     cdef:
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_Timer); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 382, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
 ...
 *         int undersized = 0
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_t, __pyx_n_s_tic); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 383, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
 ...
 */
    __pyx_v_ipn_init = (__pyx_v_ipn + 1);

    /* "NNPS_Prototype.pyx":399
 * 
 *         # Find the cell in which the current particle is.
 ...
 */
    __pyx_t_7 = __pyx_v_part_i;
    __pyx_v_cell_num = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_parts_cells.data) + __pyx_t_7)) )));

    /* "NNPS_Prototype.pyx":402
 * 
 *         # Find the particle's cell's neighbors.
 ...
 */
    __pyx_t_8.data = __pyx_v_grid.data;
    __pyx_t_8.memview = __pyx_v_grid.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_cell_num;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_grid.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_grid.strides[0];
...
__pyx_t_8.shape[0] = __pyx_v_grid.shape[1];
__pyx_t_8.strides[0] = __pyx_v_grid.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_cell_neighbors, 1);
    __pyx_v_cell_neighbors = __pyx_t_8;
    __pyx_t_8.memview = NULL;
    __pyx_t_8.data = NULL;

    /* "NNPS_Prototype.pyx":404
 *         cell_neighbors = grid[cell_num]
 * 
 *         for i in range(cell_neighbors.shape[0]):             # <<<<<<<<<<<<<<
 ...
 * 
 */
    __pyx_t_9 = (__pyx_v_cell_neighbors.shape[0]);
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_i = __pyx_t_11;

      /* "NNPS_Prototype.pyx":405
 * 
 *         for i in range(cell_neighbors.shape[0]):
 *             neighbor_cell = cell_neighbors[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_neighbor_cell = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_cell_neighbors.data) + __pyx_t_12)) )));

      /* "NNPS_Prototype.pyx":408
 * 
 *             # If zero, means it reached the end of the array, which by construction can have more slots than data.
 *             if neighbor_cell == 0:             # <<<<<<<<<<<<<<
 *                 break
 * 
 */
      __pyx_t_13 = ((__pyx_v_neighbor_cell == 0) != 0);
      if (__pyx_t_13) {

        /* "NNPS_Prototype.pyx":409
 *             # If zero, means it reached the end of the array, which by construction can have more slots than data.
 *             if neighbor_cell == 0:
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8.data = __pyx_v_cells_parts.data;
      __pyx_t_8.memview = __pyx_v_cells_parts.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_neighbor_cell;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_cells_parts.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_cells_parts.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
...
__pyx_t_8.shape[0] = __pyx_v_cells_parts.shape[1];
__pyx_t_8.strides[0] = __pyx_v_cells_parts.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_neighbor_parts, 1);
      __pyx_v_neighbor_parts = __pyx_t_8;
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;

      /* "NNPS_Prototype.pyx":414
 *             neighbor_parts = cells_parts[neighbor_cell]
 * 
 *             for j in range(neighbor_parts.shape[0]):             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_14 = (__pyx_v_neighbor_parts.shape[0]);
      __pyx_t_15 = __pyx_t_14;
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        __pyx_v_j = __pyx_t_16;

        /* "NNPS_Prototype.pyx":415
 * 
 *             for j in range(neighbor_parts.shape[0]):
 *                 part_j = neighbor_parts[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_v_part_j = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_neighbor_parts.data) + __pyx_t_17)) )));

        /* "NNPS_Prototype.pyx":418
 * 
 *                 # If zero, means it reached the end of the array.
 *                 if part_j == 0:             # <<<<<<<<<<<<<<
 *                     break
 * 
 */
        __pyx_t_13 = ((__pyx_v_part_j == 0) != 0);
        if (__pyx_t_13) {

          /* "NNPS_Prototype.pyx":419
 *                 # If zero, means it reached the end of the array.
 *                 if part_j == 0:
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_t_13 = ((__pyx_v_part_j < __pyx_v_part_i) != 0);
        if (__pyx_t_13) {

          /* "NNPS_Prototype.pyx":423
 *                 # If part j is smaller than part i, then disregard it as a pair and move to the next particle.
 *                 if part_j < part_i:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_20 = __pyx_v_part_j;
        __pyx_t_21 = 0;
        __pyx_v_r_ijx = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_18 * __pyx_v_r.strides[0]) )) + __pyx_t_19)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_20 * __pyx_v_r.strides[0]) )) + __pyx_t_21)) ))));

        /* "NNPS_Prototype.pyx":427
 *                 # Vector distance components and distance.
 *                 r_ijx = r[part_i, 0] - r[part_j, 0]
 *                 r_ijy = r[part_i, 1] - r[part_j, 1]             # <<<<<<<<<<<<<<
 *                 r_ijz = r[part_i, 2] - r[part_j, 2]
 * 
 */
        __pyx_t_22 = __pyx_v_part_i;
        __pyx_t_23 = 1;
        __pyx_t_24 = __pyx_v_part_j;
        __pyx_t_25 = 1;
        __pyx_v_r_ijy = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_22 * __pyx_v_r.strides[0]) )) + __pyx_t_23)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_24 * __pyx_v_r.strides[0]) )) + __pyx_t_25)) ))));

        /* "NNPS_Prototype.pyx":428
 *                 r_ijx = r[part_i, 0] - r[part_j, 0]
 *                 r_ijy = r[part_i, 1] - r[part_j, 1]
 *                 r_ijz = r[part_i, 2] - r[part_j, 2]             # <<<<<<<<<<<<<<
 * 
 *                 # This next section of code calculates the absolute distance for periodic boundary conditions.
 */
        __pyx_t_26 = __pyx_v_part_i;
        __pyx_t_27 = 2;
        __pyx_t_28 = __pyx_v_part_j;
        __pyx_t_29 = 2;
        __pyx_v_r_ijz = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_26 * __pyx_v_r.strides[0]) )) + __pyx_t_27)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_28 * __pyx_v_r.strides[0]) )) + __pyx_t_29)) ))));

        /* "NNPS_Prototype.pyx":433
 ...
 *                     # ======================================= X-Coordinate =============================================
 */
        __pyx_t_13 = ((__pyx_v_pbc == 1) != 0);
        if (__pyx_t_13) {

          /* "NNPS_Prototype.pyx":436
 * 
 *                     # ======================================= X-Coordinate =============================================
 *                     if pbc_x == 1:             # <<<<<<<<<<<<<<
 * 
 *                         # Regular distance in the x-direction.
 */
          __pyx_t_13 = ((__pyx_v_pbc_x == 1) != 0);
          if (__pyx_t_13) {

            /* "NNPS_Prototype.pyx":439
 * 
 *                         # Regular distance in the x-direction.
 *                         x_dist = abs(r_ijx)             # <<<<<<<<<<<<<<
 * 
 ...
 *                             # Find the periodic distance in the x-direction.
 */
            __pyx_t_13 = ((__pyx_v_x_dist > __pyx_v_kr) != 0);
            if (__pyx_t_13) {

              /* "NNPS_Prototype.pyx":445
 * 
 *                             # Find the periodic distance in the x-direction.
 *                             periodic_xdist = x_dist - x_max + x_min - dp             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_xdist) >= __pyx_v_x_dist) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":450
 *                             #  x-direction.
 *                             if abs(periodic_xdist) >= x_dist:
 *                                 periodic_xdist = x_dist             # <<<<<<<<<<<<<<
 * 
 ...
 *                                 # The component is corrected with the periodic distance within the particle support.
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_xdist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":456
 * 
 *                                 # The component is corrected with the periodic distance within the particle support.
 *                                 r_ijx = periodic_xdist             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
          __pyx_t_13 = ((__pyx_v_pbc_y == 1) != 0);
          if (__pyx_t_13) {

            /* "NNPS_Prototype.pyx":460
 *                     # ====================================== Y-Coordinate ==============================================
 *                     if pbc_y == 1:
 *                         y_dist = abs(r_ijy)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
            __pyx_t_13 = ((__pyx_v_y_dist > __pyx_v_kr) != 0);
            if (__pyx_t_13) {

              /* "NNPS_Prototype.pyx":463
 * 
 *                         if y_dist > kr:
 *                             periodic_ydist = y_dist - y_max + y_min - dp             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_ydist) >= __pyx_v_y_dist) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":466
 * 
 *                             if abs(periodic_ydist) >= y_dist:
 *                                 periodic_ydist = y_dist             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_ydist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":469
 * 
 *                             if abs(periodic_ydist) <= kr + tol:
 *                                 r_ijy = periodic_ydist             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
          __pyx_t_13 = ((__pyx_v_pbc_z == 1) != 0);
          if (__pyx_t_13) {

            /* "NNPS_Prototype.pyx":474
 * 
 *                     if pbc_z == 1:
 *                         z_dist = abs(r_ijz)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
            __pyx_t_13 = ((__pyx_v_z_dist > __pyx_v_kr) != 0);
            if (__pyx_t_13) {

              /* "NNPS_Prototype.pyx":477
 * 
 *                         if z_dist > kr:
 *                             periodic_zdist = z_dist - z_max + z_min - dp             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_zdist) >= __pyx_v_z_dist) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":480
 * 
 *                             if abs(periodic_zdist) >= z_dist:
 *                                 periodic_zdist = z_dist             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_t_13 = ((fabs(__pyx_v_periodic_zdist) <= (__pyx_v_kr + __pyx_v_tol)) != 0);
              if (__pyx_t_13) {

                /* "NNPS_Prototype.pyx":483
 * 
 *                             if abs(periodic_zdist) <= kr + tol:
 *                                 r_ijz = periodic_zdist             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_t_13 = ((__pyx_v_rij <= (__pyx_v_kr + __pyx_v_tol)) != 0);
        if (__pyx_t_13) {

          /* "NNPS_Prototype.pyx":490
 * 
 *                 if rij <= kr + tol:
 *                     ipn += 1             # <<<<<<<<<<<<<<
 * 
 ...
 *                         break
 */
          __pyx_t_13 = ((__pyx_v_ipn == __pyx_v_trial_size) != 0);
          if (__pyx_t_13) {

            /* "NNPS_Prototype.pyx":494
 *                     # Test for size of the trial ipn_pairs array.
 *                     if ipn == trial_size:
 *                         undersized = 1             # <<<<<<<<<<<<<<
 *                         break
 ...
 * 
 */
          __pyx_t_30 = __pyx_v_ipn;
          __pyx_t_31 = 0;
          *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_ipn_pairs.data + __pyx_t_30 * __pyx_v_ipn_pairs.strides[0]) )) + __pyx_t_31)) )) = __pyx_v_part_i;

          /* "NNPS_Prototype.pyx":498
 * 
 *                     ipn_pairs[ipn, 0] = part_i
 *                     ipn_pairs[ipn, 1] = part_j             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_32 = __pyx_v_ipn;
          __pyx_t_33 = 1;
          *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_ipn_pairs.data + __pyx_t_32 * __pyx_v_ipn_pairs.strides[0]) )) + __pyx_t_33)) )) = __pyx_v_part_j;
 ...
 * 
 */
      __pyx_t_13 = ((__pyx_v_undersized == 1) != 0);
      if (__pyx_t_13) {

        /* "NNPS_Prototype.pyx":502
 *             # Break out of neighbor cells loop.
 *             if undersized == 1:
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_sort); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_34 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_34)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_34);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_35.data = __pyx_v_ipn_pairs.data;
    __pyx_t_35.memview = __pyx_v_ipn_pairs.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_35, 0);
    __pyx_t_36 = -1;
    if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_35,
    __pyx_v_ipn_pairs.shape[0], __pyx_v_ipn_pairs.strides[0], __pyx_v_ipn_pairs.suboffsets[0],
    0,
    0,
    &__pyx_t_36,
    __pyx_v_ipn_init,
...

{
    ...
    Py_ssize_t __pyx_tmp_shape = __pyx_v_ipn_pairs.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_ipn_pairs.strides[1];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
...
__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_35, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    if (!__pyx_t_37) {
      __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_34, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 509, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_1);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_34)) {
        PyObject *__pyx_temp[2] = {__pyx_t_37, __pyx_t_3};
        __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_34, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 509, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_34)) {
        PyObject *__pyx_temp[2] = {__pyx_t_37, __pyx_t_3};
        __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_34, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 509, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_37); __pyx_t_37 = 0;
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      } else
      #endif
      {
        __pyx_t_38 = PyTuple_New(1+1); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 509, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_38);
        __Pyx_GIVEREF(__pyx_t_37); PyTuple_SET_ITEM(__pyx_t_38, 0, __pyx_t_37); __pyx_t_37 = NULL;
        __Pyx_GIVEREF(__pyx_t_3);
        PyTuple_SET_ITEM(__pyx_t_38, 0+1, __pyx_t_3);
        __pyx_t_3 = 0;
        __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_34, __pyx_t_38, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 509, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_34); __pyx_t_34 = 0;
    __pyx_t_34 = PyTuple_New(1); if (unlikely(!__pyx_t_34)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_34);
    __Pyx_GIVEREF(__pyx_t_1);
    ...
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_kind, __pyx_n_s_quick) < 0) __PYX_ERR(0, 509, __pyx_L1_error)
    __pyx_t_38 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_34, __pyx_t_1); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_38);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_34); __pyx_t_34 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dc_int(__pyx_t_38, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 509, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_temp, __pyx_t_35, 1, 1, 0) < 0)) __PYX_ERR(0, 510, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_t_35, 1);
    __pyx_t_35.memview = NULL;
    __pyx_t_35.data = NULL;
  }
 ...
 * # ======================================================================================================================
 */
  __pyx_t_38 = __Pyx_PyObject_GetAttrStr(__pyx_v_t, __pyx_n_s_toc); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 512, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_38);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_38, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 512, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_38); __pyx_t_38 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "NNPS_Prototype.pyx":513
 * 
 *     t.toc('Linked-list NNPS Cython')
 *     return ipn, undersized             # <<<<<<<<<<<<<<
 * # ======================================================================================================================
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_v_ipn); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 513, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_38 = __Pyx_PyInt_From_int(__pyx_v_undersized); if (unlikely(!__pyx_t_38)) __PYX_ERR(0, 513, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_38);
  __pyx_t_34 = PyTuple_New(2); if (unlikely(!__pyx_t_34)) __PYX_ERR(0, 513, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_34);
  __Pyx_GIVEREF(__pyx_t_1);
  PyTuple_SET_ITEM(__pyx_t_34, 0, __pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_38);
  PyTuple_SET_ITEM(__pyx_t_34, 1, __pyx_t_38);
  __pyx_t_1 = 0;
  __pyx_t_38 = 0;
  __pyx_r = __pyx_t_34;
  __pyx_t_34 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("NNPS_Prototype.linked_list", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_t);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cell_neighbors, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_14NNPS_Prototype_7linked_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_14NNPS_Prototype_7linked_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_parts_cells = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_cells_parts = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_grid = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("linked_list (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_r,&__pyx_n_s_parts_cells,&__pyx_n_s_cells_parts,&__pyx_n_s_grid,&__pyx_n_s_h,&__pyx_n_s_dp,&__pyx_n_s_sim_dim,&__pyx_n_s_num_parts,&__pyx_n_s_ipn_pairs,&__pyx_n_s_trial_size,&__pyx_n_s_x_min,&__pyx_n_s_x_max,&__pyx_n_s_y_min,&__pyx_n_s_y_max,&__pyx_n_s_z_min,&__pyx_n_s_z_max,&__pyx_n_s_pbc,&__pyx_n_s_pbc_x,&__pyx_n_s_pbc_y,&__pyx_n_s_pbc_z,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_parts_cells)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 1); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cells_parts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 2); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 3); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 4); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 5); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sim_dim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 6); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_parts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 7); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ipn_pairs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 8); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_trial_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 9); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 10); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 11); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 12); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 13); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_min)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 14); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 15:
        if (likely((values[15] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 15); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 16:
        if (likely((values[16] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 16); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 17:
        if (likely((values[17] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 17); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 18:
        if (likely((values[18] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 18); __PYX_ERR(0, 377, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 19:
        if (likely((values[19] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pbc_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, 19); __PYX_ERR(0, 377, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "linked_list") < 0)) __PYX_ERR(0, 377, __pyx_L3_error)
      }
    ...
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 377, __pyx_L3_error)
    __pyx_v_parts_cells = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_parts_cells.memview)) __PYX_ERR(0, 377, __pyx_L3_error)
    __pyx_v_cells_parts = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cells_parts.memview)) __PYX_ERR(0, 377, __pyx_L3_error)
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 377, __pyx_L3_error)
    __pyx_v_h = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 377, __pyx_L3_error)
    __pyx_v_dp = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_dp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_sim_dim = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_sim_dim == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_num_parts = __Pyx_PyInt_As_long(values[7]); if (unlikely((__pyx_v_num_parts == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_ipn_pairs = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ipn_pairs.memview)) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_trial_size = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_trial_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_x_min = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_x_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 378, __pyx_L3_error)
    __pyx_v_x_max = __pyx_PyFloat_AsDouble(values[11]); if (unlikely((__pyx_v_x_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_y_min = __pyx_PyFloat_AsDouble(values[12]); if (unlikely((__pyx_v_y_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_y_max = __pyx_PyFloat_AsDouble(values[13]); if (unlikely((__pyx_v_y_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_z_min = __pyx_PyFloat_AsDouble(values[14]); if (unlikely((__pyx_v_z_min == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_z_max = __pyx_PyFloat_AsDouble(values[15]); if (unlikely((__pyx_v_z_max == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_pbc = __Pyx_PyInt_As_int(values[16]); if (unlikely((__pyx_v_pbc == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_pbc_x = __Pyx_PyInt_As_int(values[17]); if (unlikely((__pyx_v_pbc_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_pbc_y = __Pyx_PyInt_As_int(values[18]); if (unlikely((__pyx_v_pbc_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 379, __pyx_L3_error)
    __pyx_v_pbc_z = __Pyx_PyInt_As_int(values[19]); if (unlikely((__pyx_v_pbc_z == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 380, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("linked_list", 1, 20, 20, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 377, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("NNPS_Prototype.linked_list", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14NNPS_Prototype_6linked_list(__pyx_self, __pyx_v_r, __pyx_v_parts_cells, __pyx_v_cells_parts, __pyx_v_grid, __pyx_v_h, __pyx_v_dp, __pyx_v_sim_dim, __pyx_v_num_parts, __pyx_v_ipn_pairs, __pyx_v_trial_size, __pyx_v_x_min, __pyx_v_x_max, __pyx_v_y_min, __pyx_v_y_max, __pyx_v_z_min, __pyx_v_z_max, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z);
...
static PyObject *__pyx_pf_14NNPS_Prototype_6linked_list(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, __Pyx_memviewslice __pyx_v_parts_cells, __Pyx_memviewslice __pyx_v_cells_parts, __Pyx_memviewslice __pyx_v_grid, double __pyx_v_h, double __pyx_v_dp, int __pyx_v_sim_dim, long __pyx_v_num_parts, __Pyx_memviewslice __pyx_v_ipn_pairs, int __pyx_v_trial_size, double __pyx_v_x_min, double __pyx_v_x_max, double __pyx_v_y_min, double __pyx_v_y_max, double __pyx_v_z_min, double __pyx_v_z_max, int __pyx_v_pbc, int __pyx_v_pbc_x, int __pyx_v_pbc_y, int __pyx_v_pbc_z) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("linked_list", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 377, __pyx_L1_error) }
  if (unlikely(!__pyx_v_parts_cells.memview)) { __Pyx_RaiseUnboundLocalError("parts_cells"); __PYX_ERR(0, 377, __pyx_L1_error) }
  if (unlikely(!__pyx_v_cells_parts.memview)) { __Pyx_RaiseUnboundLocalError("cells_parts"); __PYX_ERR(0, 377, __pyx_L1_error) }
  if (unlikely(!__pyx_v_grid.memview)) { __Pyx_RaiseUnboundLocalError("grid"); __PYX_ERR(0, 377, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ipn_pairs.memview)) { __Pyx_RaiseUnboundLocalError("ipn_pairs"); __PYX_ERR(0, 377, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_14NNPS_Prototype_linked_list(__pyx_v_r, __pyx_v_parts_cells, __pyx_v_cells_parts, __pyx_v_grid, __pyx_v_h, __pyx_v_dp, __pyx_v_sim_dim, __pyx_v_num_parts, __pyx_v_ipn_pairs, __pyx_v_trial_size, __pyx_v_x_min, __pyx_v_x_max, __pyx_v_y_min, __pyx_v_y_max, __pyx_v_z_min, __pyx_v_z_max, __pyx_v_pbc, __pyx_v_pbc_x, __pyx_v_pbc_y, __pyx_v_pbc_z, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 377, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "NNPS_Prototype.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "NNPS_Prototype._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"direct_search", (PyCFunction)__pyx_pw_14NNPS_Prototype_1direct_search, METH_VARARGS|METH_KEYWORDS, 0},
  {"create_grid", (PyCFunction)__pyx_pw_14NNPS_Prototype_3create_grid, METH_VARARGS|METH_KEYWORDS, 0},
  {"allocate_particles", (PyCFunction)__pyx_pw_14NNPS_Prototype_5allocate_particles, METH_VARARGS|METH_KEYWORDS, 0},
  {"linked_list", (PyCFunction)__pyx_pw_14NNPS_Prototype_7linked_list, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_NNPS_Prototype(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_NNPS_Prototype},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Direct_search_Cython, __pyx_k_Direct_search_Cython, sizeof(__pyx_k_Direct_search_Cython), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_Linked_list_NNPS_Cython, __pyx_k_Linked_list_NNPS_Cython, sizeof(__pyx_k_Linked_list_NNPS_Cython), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_cells_parts, __pyx_k_cells_parts, sizeof(__pyx_k_cells_parts), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_ipn_pairs, __pyx_k_ipn_pairs, sizeof(__pyx_k_ipn_pairs), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_parts_cells, __pyx_k_parts_cells, sizeof(__pyx_k_parts_cells), 0, 0, 1, 1},
  {&__pyx_n_s_pbc, __pyx_k_pbc, sizeof(__pyx_k_pbc), 0, 0, 1, 1},
  {&__pyx_n_s_pbc_x, __pyx_k_pbc_x, sizeof(__pyx_k_pbc_x), 0, 0, 1, 1},
  {&__pyx_n_s_pbc_y, __pyx_k_pbc_y, sizeof(__pyx_k_pbc_y), 0, 0, 1, 1},
  {&__pyx_n_s_pbc_z, __pyx_k_pbc_z, sizeof(__pyx_k_pbc_z), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_sim_dim, __pyx_k_sim_dim, sizeof(__pyx_k_sim_dim), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_trial_size, __pyx_k_trial_size, sizeof(__pyx_k_trial_size), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Direct_search_Cython); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 110, __pyx_L1_error)
 ...
 * # ======================================================================================================================
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_Linked_list_NNPS_Cython); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 512, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initNNPS_Prototype(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initNNPS_Prototype(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_NNPS_Prototype(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_NNPS_Prototype(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_NNPS_Prototype(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_NNPS_Prototype(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("NNPS_Prototype", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_NNPS_Prototype) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "NNPS_Prototype")) {
      if (unlikely(PyDict_SetItemString(modules, "NNPS_Prototype", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_Timer, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init NNPS_Prototype", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init NNPS_Prototype");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
